...
import { FaFilePdf, FaFilePowerpoint, FaFileImage, FaVideo, FaCloudUploadAlt } from "react-icons/fa";
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
            <div className="max-w-md w-full p-8 bg-gray-800/50 backdrop-blur-lg rounded-2xl shadow-2xl text-center border border-gray-700/50">
                ...
                <div
                    ...
                    onDrop={handleDrop}
                    className={`relative ${dragActive ? 'scale-105' : ''} transition-all duration-300`}
                >
                    <label htmlFor="fileInput" className="block cursor-pointer">
                        ...
                        <div className={`w-full border-3 border-dashed ${dragActive ? 'border-blue-500 bg-blue-500/10' : 'border-gray-500'} p-8 rounded-xl text-gray-300 hover:bg-gray-700/50 transition duration-300 flex flex-col items-center gap-4`}>
                ...
                {shareLink && (
                    <div className="mt-6 p-4 bg-gray-700/50 rounded-xl">
                        ...
                        <Link to={shareLink} className="text-blue-400 hover:text-blue-300 underline break-all">
                            {shareLink}
                        </Link>
                    </div>
                )}
